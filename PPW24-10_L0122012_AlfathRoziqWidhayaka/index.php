...
<body>
    <div class="container">
        <a class="delete-button" href="logout.php">Logout</a>
        <h1>Apple Product</h1>
        ...
        <table border="1" cellpadding="10">
            ...
            <tr>
                ...
                <td>
                    <img src="images/<?= htmlspecialchars($row['image']); ?>" alt="none">
                </td>
                <td>
                    <a href="edit.php?id=<?= htmlspecialchars($row["id"]); ?>" class="edit-button">Edit</a>
                    <a href="hapus.php?id=<?= htmlspecialchars($row["id"]); ?>" onclick="return confirm('Are you sure to delete?');" class="delete-button">Delete</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </table>
