...
// Memeriksa apakah tombol submit telah ditekan pada form
        ...
        <table>
            <tr>
                <td>
                    ...
                    <input type="text" name="code" id="code" value="<?= $appleproduct["code"]?>" required>
                </td>
            </tr>
            <tr>
                <td>
                    <label for="product_name">Product</label>
                    <input type="text" name="product_name" id="product_name" value="<?= $appleproduct["product_name"]?>" required>
                </td>  
            </tr>
            <tr>
                <td>
                    <label for="product_type">Type</label>
                    <input type="text" name="product_type" id="product_type" value="<?= $appleproduct["product_type"]?>" required>
                </td>
            </tr>
            <tr>
                <td>
                    <label for="price">Price</label>
                    <input type="text" name="price" id="price" value="<?= $appleproduct["price"]?>" required>
                </td>
            </tr>
            <tr>
                <td>
